...
// --- Patch 20: restore Linux single-instance ownership + claude:// delivery ---
//
// Appended to the main-process chunk ($INDEX). Runs during module evaluation,
// i.e. after the app has registered its own listeners but before "ready", which
// is the only window in which requestSingleInstanceLock() is still useful.
//
